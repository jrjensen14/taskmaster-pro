...
var auditTask = function(taskEl) {
  ...
  var date = $(taskEl).find("span").text().trim();
    //esure it worked
    //console.log(date);
  // convert to moment objest at 5:00pm
  var time = moment(date, "L").set("hour", 17);
  //this should print out an object for the value of the date variable, but at 5:00pm of that date
  //console.log(time);
  
  //remove any old classes fro element
  $(taskEl).removeClass("list-group-item-warning list-group-item-danger");
  
  // apply new classes it tasks is near/over due date
...
$("#trash").droppable({
  ...
  drop: function(event, ui) {
    // remove draggable element from the DOM
    ui.draggable.remove();
    console.log("drop");
  },
  over: function(event, ui) {
...
$(".list-group").on("blur", "textarea", function() {
  ...
  // get the paretnts ul's id attibute
  var status = $(this)
    .closest(".list-group")
    .attr("id")
    .replace("list-", "");
...
$(".list-group").on("change", "input[type='text']", function() {
  ...
  // get the parentss ul's id attribute
  var status = $(this)
    .closest(".list-group")
    .attr("id")
    .replace("list-", "");

  //get the task's postion in th list of other li elements
  var index = $(this)
    .closest(".list-group-item")
    .index();
